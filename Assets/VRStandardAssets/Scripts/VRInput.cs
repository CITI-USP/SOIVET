    ...
    public class VRInput : MonoBehaviour
    {
        ...
        private void CheckInput()
        {
			...
			if (Input.GetButtonDown("Fire1"))
				GameObject.Find("texto").GetComponent<TextMesh>().text = "Fire1";

			if (Input.GetButtonDown("Fire2"))
				GameObject.Find("texto").GetComponent<TextMesh>().text = "Fire2";

			if (Input.GetButtonDown("Fire3"))
				GameObject.Find("texto").GetComponent<TextMesh>().text = "Fire3";
			
			if (Input.GetButtonDown("Jump"))
				GameObject.Find("texto").GetComponent<TextMesh>().text = "Jump";

			if (Input.GetButtonDown("Button 1"))
				GameObject.Find("texto").GetComponent<TextMesh>().text = "Button 1";

			if (Input.GetButtonDown("Button 0"))
				GameObject.Find("texto").GetComponent<TextMesh>().text = "Button 0";

			if (Input.GetButtonDown("Button 10"))
				GameObject.Find("texto").GetComponent<TextMesh>().text = "Button 10";
			
			if (Input.GetMouseButtonDown(0))
				GameObject.Find("texto").GetComponent<TextMesh>().text = "GetMouseButtonDown(0)";

			if (Input.GetButtonDown("1"))
				GameObject.Find("texto").GetComponent<TextMesh>().text = "1";

			if (Input.GetButtonDown("0"))
				GameObject.Find("texto").GetComponent<TextMesh>().text = "0";*/


			if (Input.GetButtonUp("Jump") || Input.GetButtonUp("0") || Input.GetButtonUp("1") || Input.GetButtonDown("Fire1") || Input.GetButtonDown("Fire2") || Input.GetButtonDown("Fire3"))
            {				
			...
			if (Input.GetButtonUp("Jump") || Input.GetButtonUp("0") || Input.GetButtonUp("1") ||Input.GetButtonUp ("Fire1") || Input.GetButtonDown("Fire2") || Input.GetButtonDown("Fire3"))
            {
